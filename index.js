/**
 * EXXEED BLOG SYSTEM V4
 * Features: Mobile Nav, Stealth Theme Toggle, Pagination, Iconography
 */
  ...
  <body>
    ...
    <main class="right-pane" id="rightPane">
      ...
      <div id="view-home" class="content-container active-view">
        ...
        <div class="dossier-section" style="margin-top: 6rem; padding-top: 4rem; border-top: 2px solid var(--border);">
            ...
            <p style="font-size: 1.2rem; line-height: 1.6; margin-bottom: 3rem; color: var(--text-muted);">
              Former PMA Cadet turned Full-Stack Developer. Discipline translated to code.
            </p>
            <div style="border-left: 1px solid var(--border); padding-left: 2rem;">
              <div style="margin-bottom: 2rem;">
                <span style="font-family:'JetBrains Mono'; color:var(--accent);">2025 - PRESENT</span>
                <h3>Freelance Developer</h3>
              </div>
              <div>
                <span style="font-family:'JetBrains Mono'; color:var(--accent);">2021 - 2024</span>
                <h3>PMA Cadet</h3>
              </div>
            </div>
        </div>
    ...
    <script>
      let allPosts = [];
      let filteredPosts = []; // For search + pagination
      let limits = { archive: 5, admin: 5 };
      ...
      function toggleMobileNav() {
        document.getElementById('mainNav').classList.toggle('active-mobile');
      }
      ...
      function sanitize(str) {
         ...
         temp.innerText = str; 
         return temp.innerHTML; // Basic sanitization escaping HTML
      }
      ...
      function renderList(type) {
         ...
         // Determine which data to show (filtered vs all)
         // Note: Currently filteredPosts is global. If we search in Archive, Admin shouldn't change theoretically.
         // But for simplicity in this single-file setup, search applies globally or we need distinct states.
         // Let's assume search updates filteredPosts.
